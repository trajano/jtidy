...
/**
 * Testsuite for all the test cases tests failing with unneeded blank lines or spaces.
 * @author Fabrizio Giustina
 * @version $Revision$ ($Author$)
 */
public final class AllFailingBlanklinesTests
{

    /**
     * Should not be instantiated.
     */
    private AllFailingBlanklinesTests()
    {
    }
