...
public final class TidyUtils
{
     ...
     * @return unsigned int
     */
    static int toUnsigned(final int c)
    {
        return c & 0xFF;
    }
     ...
     */
    static boolean wsubstrn(final String s1, final int len1, final String s2)
    {
        final int searchIndex = s1.indexOf(s2);
     ...
     * @return true if s1 contains s2 in the range 0-len1
     */
    static boolean wsubstrncase(final String s1, final int len1, final String s2)
    {
     ...
     */
    static int wstrnchr(final String s1, final int len1, final char cc)
    {
        final int indexOf = s1.indexOf(cc);
        if (indexOf < len1)
        {
            return indexOf;
        }
     ...
     */
    static boolean wsubstr(final String s1, final String s2)
    {
        int i;
     ...
     */
    static boolean isxdigit(final char c)
    {
     ...
     */
    static boolean isInValuesIgnoreCase(final String[] validValues, final String valueToCheck)
    {
        final int len = validValues.length;
        for (int j = 0; j < len; j++)
        {
     ...
     */
    public static boolean findBadSubString(final String s, final String p, int len)
    {
     ...
     */
    static boolean isXMLLetter(final char c)
    {
     ...
     */
    static boolean isXMLNamechar(final char c)
    {
     ...
     */
    static boolean isQuote(final int c)
    {
        return c == '\'' || c == '\"';
    }
     ...
     */
    public static int lastChar(final String str)
    {
     ...
     */
    public static boolean isWhite(final char c)
    {
        final short m = map(c);
     ...
     */
    public static boolean isLower(final char c)
    {
        final short map = map(c);
     ...
     */
    public static boolean isUpper(final char c)
    {
        final short map = map(c);
     ...
     */
    public static char foldCase(char c, final boolean tocaps, final boolean xmlTags)
    {
     ...
     */
    private static void mapStr(final String str, final short code)
    {
        int c;
     ...
     * @return char type
     */
    private static short map(final char c)
    {
